...
- Release readiness now records that M17b is synthetic-only/foreground/loopback-only, M17c passed for one approved local live profile, M17d passed for approved loopback user services, and M17e passed its bounded synthetic LAN pilot with remote unlisted-host negative reachability proof.
